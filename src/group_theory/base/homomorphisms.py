...
class Homomorphism:
    ...
    def validate_homomorphism(self) -> bool:
        ...
        The main idea is that a map f:G -> H is a homomorphism if and only if the subgroup generated by (g,f(g)) (see the method get_graph below)
        has trivial intersection with {1}xH in GxH, if and only if this generated subgroup has the same order as G.
        '''
