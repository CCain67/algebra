...
def Inn(G: Group) -> Group:
    ...
    InnG = Group(inner_automorphisms)
...
def _check_preserves_subgroup(
    A: Automorphism, H: Subgroup, needs_verification: bool = False
) -> bool:
    ...
    for in_out_dict in potential_automorphisms:
        if in_out_dict in updated_potential_automorphisms:
            ...
            fixes_subgroup = _check_preserves_subgroup(
                F, relative_subgroup, verify_preserves_subgroup
            )
            ...
            if all(
                ...
                automorphisms = list(
                    {A * F for A in automorphisms}
                    .union({F * A for A in automorphisms})
